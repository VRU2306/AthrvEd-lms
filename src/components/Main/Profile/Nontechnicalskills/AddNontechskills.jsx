...
const Nontech = ({ open, handleClose }) => {
    const [skills, setSkills] = React.useState("");
    const classes = useStyles();
    const postNontechSkills = useStoreActions(
        action => action.profileMod.POST_NONSKILLS_START
    );
        ...
        >
            <div className={classes.msx}>
                <ValidatorForm
                    id="this-form"
                    onSubmit={() => {
                        postNontechSkills({ skills, });
                        // console.log(skills)
                        handleClose();
                    }}
                >

                    <p className="nontechskillhead">Add a new Non-Technical Skill</p>
                    <DialogContent>
                        <br></br>
                        <ThemeProvider theme={defaultMaterialTheme}>
                            <TextValidator
                                ...
                                size="small"
                                type="text"
                                placeholder="Non-Tecnhnical Skills"
